...
export function PhoneFrame({
  ...
  return (
    <div
      className="relative shrink-0 overflow-hidden rounded-[44px] border-[10px] border-[#0b1220] bg-bg-app shadow-[0_0_80px_-20px_rgba(92,53,204,0.3),0_0_20px_-5px_rgba(255,255,255,0.1)] ring-1 ring-white/10"
    ...
    >
      ...
      <motion.div
        ...
        className="phone-root relative flex h-full w-full flex-col"
      ...
      {/* Home Indicator */}
      <div className="pointer-events-none absolute bottom-2 left-1/2 z-[400] h-1.5 w-[134px] -translate-x-1/2 rounded-full bg-slate-900" />
    </div>
  );
}
